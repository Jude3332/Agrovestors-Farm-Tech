        ...
        <div class="grid grid-cols-5 gap-6">
          <div class="col-span-3">
            <div class="aspect-square flex items-center">
              <img src="./public/img/agro1_1.jpg" alt="" />
            </div>
            <div class="flex relative">
              <button
                class="absolute left-0 top-0 h-full text-white bg-black/30 hover:bg-black/50"
              >
                <svg
              ...
              <button
                class="absolute right-0 top-0 h-full text-white bg-black/30 hover:bg-black/50"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-8 w-8"
              ...
              <a
                href="#"
                class="flex items-center w-24 h-24 border border-1 border-gray-300 hover:border hover:border-purple-600 transition-colors"
              >
                <img src="./public/img/agro1_2.jpg" alt="" />
              </a>
              <a
                href="#"
                class="flex items-center w-24 h-24 border border-1 border-gray-300 hover:border hover:border-purple-600 transition-colors"
              >
                <img src="./public/img/agro1_3.jpg" alt="" />
              </a>
              <a
                href="#"
                class="flex items-center w-24 h-24 border border-1 border-gray-300 hover:border hover:border-purple-600 transition-colors"
              >
                <img src="./public/img/agro1_4.jpg" alt="" />
              </a>
              <a
                href="#"
                class="flex items-center w-24 h-24 border border-1 border-gray-300 hover:border hover:border-purple-600 transition-colors"
          ...
          <div class="col-span-2">
            ...
            <div class="text-xl font-bold mb-6">$17.99</div>

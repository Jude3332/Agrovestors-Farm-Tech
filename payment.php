    ...
    <main class="bg-gray-200">
        <div class="h-full w-full flex py-40 px-48 justify-between ">
            <div class="items-center w-[600px]">
                <h2 class="text-3xl font-semibold pb-5">Payment</h2>
                <hr class=" bg-gray-300 pb-1 w-full">
                <p class="pt-5 pb-5 text-base">Agrovestors Farm-Tech Limited currently accepts Payments through Direct Bank Deposit, Online Payments and PayPal</p>
                <h5 class="text-4xl font-semibold pb-5">Direct Bank Payments <br> (Nigeria)</h5>
                <p><span class="text-black text-bold">Fidelity Bank</span></p>
                <p><span class="text-black text-bold">Account Name :</span> Agrovestors Farm</p>
                <p><span class="text-black text-bold">Account No :</span> 2172213956</p>
                <h5 class="text-4xl font-semibold pt-4 pb-5">Online Payments (# & $):</h5>
                <button class="payment bg-blue-600 rounded h-10 w-[400px] text-white">Click to pay online (Nigeria and international cards)</button>
            </div>

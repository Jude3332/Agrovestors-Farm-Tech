        ...
        <div class="bg-white p-4 rounded-lg shadow">
          ...
          <div>
            ...
            <div class="flex  sm:flex-row items-center gap-4">
              <img src="./public/img/thumbagro.jpeg" class="w-36" alt="" />
            ...
            <!-- Product Item -->
            <div class="flex sm:flex-row items-center gap-4">
              <img src="./public/img/agro1_2.jpg" class="w-36" alt="" />
              <div class="flex flex-col justify-between">
                <div class="flex justify-between mb-3">
                  <h3>
                    Logitech G502 HERO High Performance Wired Gaming Mouse, HERO
            ...
            <!-- Product Item -->
            <div class="flex sm:flex-row items-center gap-4">
              <img src="./public/img/agro1_4.jpg" class="w-36" alt="" />
              <div class="flex flex-col justify-between">
                <div class="flex justify-between mb-3">
                  <h3>
                    Logitech G502 HERO High Performance Wired Gaming Mouse, HERO
            ...
            <!-- Product Item -->
            <div class="flex sm:flex-row items-center gap-4">
              <img src="./public/img/agro1_1.jpg" class="w-36" alt="" />
              <div class="flex flex-col justify-between">
                <div class="flex justify-between mb-3">
                  <h3>
                    Logitech G502 HERO High Performance Wired Gaming Mouse, HERO
